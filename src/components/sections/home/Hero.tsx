...
const DEFAULT_HERO = {
  badge: 'New: Enterprise AI Platform',
  title: 'Scale your business with',
  titleHighlight: 'intelligent automation',
  description:
    'Transform your workflows with our AI-powered SaaS platform. Reduce manual tasks by 80% and accelerate growth with intelligent insights and seamless integrations.',
  features: [
  ...
  statsLabel2: 'Cost Reduction',
  statsValue2: '65% savings',
} as const;
