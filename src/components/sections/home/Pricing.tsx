...
const DEFAULT_PRICING = {
  ...
  mainDescription:
    'Choose the perfect plan to accelerate your SaaS growth. Start free, upgrade as you scale. No hidden fees or long-term commitments.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 25%',
  plan1Name: 'Starter',
  plan1Description: 'Perfect for solo developers and early-stage startups',
  plan1Price: 'Free',
  plan1CTA: 'Start Building',
  plan1CTAHref: '/',
  plan2Name: 'Growth',
  plan2Description: 'Ideal for growing teams and scaling applications',
  plan2Price: '$49',
  plan2Period: '/month',
  ...
  plan3Description: 'Custom solutions for large-scale operations',
  plan3Price: 'Custom',
  ...
  bottomDescription:
    'Our enterprise team specializes in building tailored SaaS solutions for complex business requirements. Get dedicated support, custom integrations, and white-label options.',
  bottomCTA: 'Talk to Sales',
  bottomCTAHref: '/',
} as const;
