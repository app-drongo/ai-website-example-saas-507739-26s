...
const DEFAULT_FOOTER = {
  logoText: 'Example SaaS',
  companyDescription:
    'Streamline your business operations with our comprehensive SaaS platform. Trusted by over 10,000 companies worldwide to automate workflows, manage teams, and drive growth through intelligent analytics.',
  contactEmail: 'support@examplesaas.com',
  ...
  section4Title: 'Legal',
  copyrightText: '© 2024 Example SaaS. All rights reserved.',
  madeWithText: 'by our engineering team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/examplesaas',
  social2Href: 'https://facebook.com/examplesaas',
  social3Href: 'https://instagram.com/examplesaas',
  social4Href: 'https://linkedin.com/company/examplesaas',
  social5Href: 'https://github.com/examplesaas',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Dashboard', href: '/dashboard', editableId: 'link-footer-dashboard' },
        { name: 'Analytics', href: '/analytics', editableId: 'link-footer-analytics' },
        { name: 'Automation', href: '/automation', editableId: 'link-footer-automation' },
        { name: 'Team Management', href: '/teams', editableId: 'link-footer-teams' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'SLA Agreement', href: '/sla', editableId: 'link-footer-sla' },
      ],
    },
  ];
